...
public class Snowflake {
     ...
     */
    private final long startTimeMillis = 1704067200000L; // UTC = 2024-01-01T00:00:00Z
    ...
    public synchronized long nextId() {
        ...
        if (currentTimeMillis == lastTimeMillis) {
            ...
            if (sequence == 0) {
                currentTimeMillis = _waitNextMilis(currentTimeMillis);
            }
        } else {
            sequence = 0;
        }
    ...
    private long _waitNextMilis(long currentTimestamp) {
